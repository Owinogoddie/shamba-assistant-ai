...
import { SVGLoader } from "@/components/loader-svg";
...
export function ChatWindow({
  ...
  useEffect(() => {
    if (formSubmitted && generatedMessage) {
      setInput(generatedMessage);
  ...
  }, [formSubmitted, generatedMessage, setInput, setFormSubmitted]);
