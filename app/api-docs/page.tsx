    ...
    <div className="min-h-screen bg-green-50">
      <nav className="bg-green-600 p-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <h1 className="text-2xl font-bold text-white">
            <Link href="/">Shamba Assistant AI API</Link>
          </h1>
          <Link
      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-xl text-green-600 text-center mb-12">
          Explore our powerful API endpoints designed to help farmers with crop
          management, disease detection, and soil analysis.
        </p>
